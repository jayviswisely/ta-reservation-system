...
$admin_name = $_SESSION['full_name'] ?? 'Professor';

$sql = "SELECT c.course_id, c.course_name, u.full_name AS professor_name 
        FROM courses c 
...
<body>
    ...
    <div class="dashboard-body">
        <h1 class="dashboard-message">Hello, <?= htmlspecialchars($admin_name) ?></h1>
